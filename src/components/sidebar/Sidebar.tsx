...
export const Sidebar = ({ nav }: { nav: SidebarType[] }) => {
  ...
  return (
    <div className={changePosition ? styles.sidebarContainerDynamic : styles.sidebarContainer}>
      <div>
        <div className={styles.sidebarTitleContainer}>
          ...
          <button className={styles.titleButton} onClick={() => setChangePosition(!changePosition)}>
        ...
        <div className={styles.navContainer}>
        {
          nav.map((item) => {
            return (
                <Link to={item.link} className={` ${currentPath === item.link ? styles.linkTo: styles.selectedLinkTo } `} key={item.label}>
